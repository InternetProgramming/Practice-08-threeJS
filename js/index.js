...
var matCabin = new THREE.MeshPhongMaterial({color:Colors.orange, shading:THREE.FlatShading});
...
var matTailPlane = new THREE.MeshPhongMaterial({color:Colors.orange, shading:THREE.FlatShading});
...
var matSideWing = new THREE.MeshPhongMaterial({color:Colors.orange, shading:THREE.FlatShading});
...
var wheelProtecMat = new THREE.MeshPhongMaterial({color:Colors.orange, shading:THREE.FlatShading});
...
var wheelAxisGeom = new THREE.CircleGeometry(5,10,6);
...
var suspensionMat = new THREE.MeshPhongMaterial({color:Colors.orange, shading:THREE.FlatShading});
...
for (var i=0; i<this.ennemiesInUse.length; i++){
  ...
  if (d<game.ennemyDistanceTolerance){
    particlesHolder.spawnParticles(ennemy.mesh.position.clone(), 15, 0x383B39, 3);
...
for (var i=0; i<this.coinsInUse.length; i++){
  ...
  if (d<game.coinDistanceTolerance){
    ...
    particlesHolder.spawnParticles(coin.mesh.position.clone(), 5, 0x40B266, .8);
    addEnergy();
    i--;
